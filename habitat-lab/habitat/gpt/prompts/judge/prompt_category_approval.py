...
def approve_category_prompt(time_, human_thoughts, human_acts, robot_thoughts, robot_acts, predicates_num):
    contents = f"""
    Input:
...
def approve_category(time_, human_thoughts, human_acts, robot_thoughts, robot_acts, output_path, existing_response=None, temperature_dict=None, 
    ...
    collaboration_user_contents_filled = approve_category_prompt(time_, human_thoughts, human_acts, robot_thoughts, robot_acts, predicates_num)
