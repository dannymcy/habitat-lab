...
if __name__ == "__main__":
    ...
    human_conversation_hist = intention_proposal_gpt4(data_path, scene_id, room_list, temperature_dict, model_dict, start_over=False)
    ...
    human_conversation_hist = predicates_proposal_gpt4(data_path, scene_id, times, sampled_motion_list, sampled_static_obj_dict_list, dynamic_obj_room_mapping,human_conversation_hist, temperature_dict, model_dict, start_over=False)
